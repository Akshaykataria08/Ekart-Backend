package com.hashkart.couponmicroservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.hashkart.couponmicroservice.service.*)" +
      " || within(com.hashkart.couponmicroservice.controller.*)")
